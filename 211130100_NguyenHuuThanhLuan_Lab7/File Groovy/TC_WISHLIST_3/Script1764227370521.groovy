...
/* ================================
   VÀO TRANG ĐĂNG NHẬP
================================ */
TestObject accountBtn = findTestObject('Object Repository/Page_Nest - Laravel Multipurpose eCommerce Script/span_Account')
...
// Thực hiện click Add to Wishlist (Lần 1 - ĐÚNG)
...
================================ */
TestObject wishlistLink = findTestObject('Object Repository/Page_Seeds of Change Organic Quinoe/span_Wishlist')
