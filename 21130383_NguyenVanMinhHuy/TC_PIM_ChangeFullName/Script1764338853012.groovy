...
WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/span_Minh Huy N'))

WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/a_Chnh sa ti khon'))

WebUI.setText(findTestObject('Object Repository/Page_Ci t ti khon/input_H v tn_name'), 'Minh Huy')
