...
WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/div_Tt c danh mcTt c danh mcQun o  lm p chi_7494b5'))

WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/span_Minh Huy'))

WebUI.click(findTestObject('Object Repository/Page_Ci t ti khon/div_Ci t ti khon Thng tin h sCp nht thng ti_1697f7'))

WebUI.setText(findTestObject('Object Repository/Page_Ci t ti khon/input_H v tn_name'), '')
