...
WebUI.click(findTestObject('Object Repository/Page_S a ch/svg_Chnh sa_icon me-1 svg-icon-ti-ti-edit'))

WebUI.setText(findTestObject('Object Repository/Page_Chnh sa a ch 13/input_H v tn_address-name'), 'Minh Huy Nguyễn')

WebUI.click(findTestObject('Object Repository/Page_Chnh sa a ch 13/button_Cp nht'))
