...
WebUI.click(findTestObject('Product Tags Page/tag_list_item', [('name') : targetName]), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Product Tags Form/tag_description_input'), description)
...
WebUI.verifyElementText(findTestObject('Page_New product tag  Botble Technologies/textarea_Description_description'), description)
