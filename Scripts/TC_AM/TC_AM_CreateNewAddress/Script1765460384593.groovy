...
WebUI.click(findTestObject('Object Repository/Page_S a ch/a_Thm a ch u tin'))

WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_H v tn_address-name'), 'Minh Huy')

WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_land Islands_address-phone'), '535734573')
...
WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_BangTnh_state'), 'Bình Định')

WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_Thnh ph_city'), 'Quy Nhơn')
