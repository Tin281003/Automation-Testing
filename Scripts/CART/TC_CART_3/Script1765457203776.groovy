...
TestObject rememberMe = findTestObject('Object Repository/Page_ng nhp/input_Mt khu_remember_dc3c99bb4e249a95567a2_45c484')
...
// Click vào checkbox "Ghi nhớ tôi" (chưa rõ mục đích, nếu cần thì giữ lại)
...
WebUI.delay(1 // Đợi phản hồi của Ajax/trang
    )

/* ================================
   VÀO GIỎ HÀNG & TĂNG SỐ LƯỢNG
================================ */
...
TestObject increaseBtn1 = findTestObject('Object Repository/Page_Gi hng/i_2,026.00_fi-rs-angle-small-up')

TestObject increaseBtn2 = findTestObject('Object Repository/Page_Gi hng/i_2,026.00_fi-rs-angle-small-up_1')

// Click tăng số lượng lần 1
WebUI.waitForElementClickable(increaseBtn1, timeout)

WebUI.click(increaseBtn1)

WebUI.delay(1 // Đợi Ajax cập nhật giỏ hàng
    )

// Click tăng số lượng lần 2
WebUI.waitForElementClickable(increaseBtn2, timeout // Cần đảm bảo locator này vẫn đúng sau khi giỏ hàng được cập nhật
    )

WebUI.click(increaseBtn2)
