...
WebUI.click(findTestObject('Object Repository/Page_Nest - Tp lnh thng mi in t a nng ca Laravel/div_concat(id(, , page-home, , )divclass, ,_3ea703'))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Ci t ti khon/input_Mt khu hin ti_old_password'), 'RigbBhfdqOBGNlJIWM1ClA==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Ci t ti khon/input_Mt khu_password'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Ci t ti khon/input_Xc nhn mt khu_password_confirmation'), 
    'qeJ0sjJnwEs=')

WebUI.click(findTestObject('Object Repository/Page_Ci t ti khon/form_Mt khu hin ti  .input-password-toggle _840a51'))

WebUI.click(findTestObject('Object Repository/Page_Ci t ti khon/button_i mt khu'))
