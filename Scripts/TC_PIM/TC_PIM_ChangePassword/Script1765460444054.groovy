...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Ci t ti khon/input_Mt khu hin ti_old_password'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Ci t ti khon/input_Mt khu_password'), 'RigbBhfdqOBGNlJIWM1ClA==')
