...
// Nhập Username & Password (Thay đổi thông tin của bạn nếu cần)
...
// --- BƯỚC 2: TÌM KIẾM, HỦY ĐƠN VÀ GHI CHÚ ---
...
// Nhấn Enter để thực hiện tìm (thường cần thiết sau khi nhập)
WebUI.sendKeys(inputSearch, Keys.chord(Keys.ENTER))

// Chờ 2s để danh sách load lại
WebUI.delay(2)
...
// Click nút Hủy đơn (Cancel Order button)
// Code cũ: selenium.click("xpath=//div[@id='main-order-content']/div/div[2]/div/div[3]/div/button")
...
// Click Xác nhận hủy (Confirm Cancel)
// Code cũ: selenium.click("id=confirm-cancel-order-button")
...
// Chờ modal đóng hoặc trang load nhẹ
WebUI.delay(1)

// Click vào ô Private Notes
// Code cũ: selenium.click("id=private_notes")
TestObject txtPrivateNote = new TestObject().addProperty("id", ConditionType.EQUALS, "private_notes")
WebUI.click(txtPrivateNote)

// Nhập nội dung "het hang"
// Code cũ: selenium.type("id=private_notes", ("het hang").toString())
WebUI.setText(txtPrivateNote, "het hang")

// Click nút Gửi ghi chú (Save Note button)
// Code cũ: selenium.click("xpath=//div[@id='main-order-content']/div[2]/div/div/div[2]/div/div/form/button")
TestObject btnSaveNote = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//div[@id='main-order-content']/div[2]/div/div/div[2]/div/div/form/button")
WebUI.click(btnSaveNote)
