...
// TC05: Submit review with Vietnamese accents and special characters
...
selenium.click("id=rating-star-4")
String comment = "Sản phẩm tuyệt vời — ngon, rẻ, dễ dùng! @#€%&*()"
selenium.type("name=comment", comment)
selenium.click("xpath=//div[@id='Reviews']/div/div/div[2]/form/button")

softAssertion.assertTrue(selenium.isTextPresent("Sản phẩm tuyệt vời"), "Special-character review should appear")
