...
// TC06: Submit a review and immediately verify it appears in the Reviews list
...
selenium.type("name=comment", uniqueComment)
...
softAssertion.assertTrue(selenium.isTextPresent(uniqueComment), "New review should appear with unique text")
