...
// TC04: Login, choose rating but submit empty comment -> expect validation
...
boolean hasValidation = selenium.isTextPresent("bắt buộc") || selenium.isTextPresent("required") || selenium.isTextPresent("Vui lòng nhập")
