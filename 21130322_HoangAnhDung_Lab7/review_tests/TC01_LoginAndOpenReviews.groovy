...
// TC01: Login and open product Reviews tab
...
// open sample product and Reviews tab
selenium.open(baseUrl + "/products/angies-boomchickapop-sweet-salty-kettle-corn")
selenium.click("id=Reviews-tab")

softAssertion.assertTrue(selenium.isElementPresent("id=Reviews-tab"), "Reviews tab should be present")
