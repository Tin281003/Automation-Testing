...
WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/svg_Qun l a ch_icon ms-1 svg-icon-ti-ti-arr_1758e9'))

WebUI.click(findTestObject('Object Repository/Page_S a ch/a_Thm a ch khc'))

WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_H v tn_address-name'), 'Minh Huy Nguyễn')
