...
WebUI.click(findTestObject('Object Repository/Page_Nest - Tp lnh thng mi in t a nng ca Laravel/a_ng nhp'))
...
WebUI.click(findTestObject('Object Repository/Page_Nest - Tp lnh thng mi in t a nng ca Laravel/span_Minh Huy'))

WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/a_Chnh sa ti khon'))

WebUI.click(findTestObject('Object Repository/Page_Ci t ti khon/div_84'))

WebUI.setText(findTestObject('Object Repository/Page_Ci t ti khon/input_land Islands_phone-field-JSihrgTX'), '4534683478')
