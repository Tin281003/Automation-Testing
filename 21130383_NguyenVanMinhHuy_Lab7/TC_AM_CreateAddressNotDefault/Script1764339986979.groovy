...
WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_H v tn_address-name'), 'Huy Nguyễn')

WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_land Islands_address-phone'), '542587345')
...
WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_Thnh ph_city'), 'TD')

WebUI.setText(findTestObject('Object Repository/Page_To a ch/input_a ch_address'), '325/v')
