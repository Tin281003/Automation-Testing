...
WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/svg_Tng quan_icon svg-icon-ti-ti-camera'))

WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon/div_Cho mng tr li, Minh Huy  Qun l ti khon,_54ad3f'))
